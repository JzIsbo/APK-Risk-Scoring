...
class PopulationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'message' => 'Data debitur berhasil ditambahkan!',
            'data' => $population
        ], 201);
    }
    ...
    /**
     * API to preview the calculated risk score and level in real-time.
     */
    ...
    /**
     * Recalculate risk scores for all populations.
     */
    ...
    /**
     * Import population records from Excel/CSV file.
     */
    public function importExcel(Request $request)
    {
        ...
        try {
            ...
            if (count($rows) <= 1) {
                return response()->json(['message' => 'Berkas Excel kosong atau tidak memiliki baris data.'], 422);
            }
            ...
            foreach ($essentialFields as $field) {
                if ($mappedIndexes[$field] === -1) {
                    return response()->json(['message' => "Kolom penting '{$field}' tidak dapat dicocokkan di file Excel. Pastikan nama header sesuai."], 422);
                }
            }
