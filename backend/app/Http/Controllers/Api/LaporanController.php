...
{
    /**
     * Get report listing statistics and filters in JSON.
     */
    ...
    /**
     * Get print-ready layout data for PDF representation.
     */
    public function getPdfData(Request $request)
    {
        ...
        // Risk distribution by CO class
        $riskByCoRaw = (clone $query)->select('co_class', 'risk_level', DB::raw('count(*) as total'))
            ->groupBy('co_class', 'risk_level')
            ->get();
