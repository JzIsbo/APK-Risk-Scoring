...
{
    /**
     * Get list of alerts and debtor highlights needing attention.
     */
    ...
    public function markRead(Request $request, $id)
    {
        ...
        return response()->json([
            'success' => true,
            'id' => $id,
            'message' => "Notifikasi #{$id} ditandai sebagai terbaca."
        ]);
    }
    ...
    /**
     * Generate alerts dynamically from database snapshot.
     */
    private function generateAlerts(): array
    {
        ...
        if ($highCount > 0 && $total > 0) {
            ...
            if ($pct >= 30) {
                $alerts[] = [
                    ...
                    'time'     => $now,
                    'action_url' => '/risk-analysis?risk_level=High',
        ...
        if ($noOrderHighRisk > 0) {
            $alerts[] = [
                ...
                'time'     => $now,
                'action_url' => '/populasi?risk_level=High',
        ...
        if ($lowCount > 0 && $total > 0) {
            ...
            $alerts[] = [
                ...
                'time'     => $now,
                'action_url' => '/risk-analysis?risk_level=Low',
                'action_label' => 'Lihat Detail',
                'read'     => true,
            ];
        }
